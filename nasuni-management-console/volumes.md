...
* To initiate a snapshot, click Take Snapshot ![](Volumes-10.gif) . A snapshot is initiated for the volume.
* This function can also be performed using the NMC API. For details, see [_NMC API_](http://docs.api.nasuni.com/) .
...
* To prioritize snapshots, click Prioritize Snapshot ![](Volumes-11.gif) .
...
To enable Prioritized Snapshot, click Prioritize Snapshot ![](Volumes-12.gif) for the volume. As long as another volume on this Nasuni Edge Appliance does not already have the Prioritized Snapshot state, and another Nasuni Edge Appliance does not already have the Prioritized Snapshot state for this volume, the Prioritize Snapshot dialog box appears.
...
The state changes to a red ![](Volumes-14.gif) . The snapshot is prioritized.

To cancel Prioritized Snapshot, click the red ![](Volumes-15.gif) . The Prioritize Snapshot dialog box appears.

![](Volumes-16.gif)

_**Prioritize Snapshot dialog box.**_

Click Cancel Prioritization. The state of the Prioritize Snapshot item changes to black and white ![](Volumes-17.gif) . The snapshot is no longer prioritized.

* To delete a local volume, click Delete ![](Volumes-18.gif) . See [See Deleting a local volume](Volumes.htm#37974).
...
* To disconnect a remote volume, click Disconnect ![](Volumes-19.gif) . See [See Disconnecting from a remote volume](Volumes.htm#22003)
...
* On the Volume List, click Delete ![](Volumes-30.gif) next to the volume you want to delete.
...
1. Click Disconnect ![](Volumes-35.gif) . The Disconnect Volume dialog box appears.
...
1. For the volume that you want to take a snapshot of, click Take Snapshot ![](Volumes-37.gif) .
...
If a particular client has other limits, the smaller of the two limits applies. 3. Click Search ![](Volumes-51.gif) . The Search Versions dialog box appears.
...
1. On the Exports page, click Edit ![](Volumes-69.gif) . The Edit Export dialog box appears._F_
...
1. On the Exports page, click Edit Host Options ![](Volumes-71.gif) . The NFS Host Options dialog box appears.
...
1. On the Exports page, click Delete ![](Volumes-74.gif) . The Delete Export dialog box appears.
...
1. Enter a partial or complete group name, then click Search ![](Volumes-79.gif) . The Select Group dialog box appears, containing the partial or complete group name.
...
3. Click Search ![](Volumes-83.gif) . The Select User dialog box appears, containing the partial or complete user name.
...
1. On the FTP Directories page, click Edit ![](Volumes-86.gif) . The Edit FTP Directory dialog box appears.
...
1. On the FTP Directories page, click Delete ![](Volumes-88.gif) . The Delete FTP Directory dialog box appears.
...
1. Enter a partial or complete group name, then click Search ![](Volumes-94.gif) . The Select Group dialog box appears, containing the partial or complete group name.
...
1. Enter a partial or complete user name.
2. To specify a local user name (native to the Nasuni Edge Appliance), include the name of the local Nasuni Edge Appliance in the query string.
3. Click Search ![](Volumes-98.gif) . The Select User dialog box appears, containing the partial or complete user name.
...
1. Enter a partial or complete group name, then click Search ![](Volumes-104.gif) . The Select Group dialog box appears, containing the partial or complete group name.
...
1. On the Shares page, for the selected share, click Edit ![](Volumes-111.gif) . The Edit Share dialog box appears.
...
1. On the Shares page, click Delete ![](Volumes-113.gif) . The Delete Share dialog box appears.
...
* To enable or disable compression, or change the chunk size, click Edit ![](Volumes-119.gif) . The Change Volume Cloud I/O dialog box appears.
...
1. On the Volume Encryption Keys page, for the selected volume, click Edit ![](Volumes-125.gif) . The Edit Encryption Keys dialog box appears.
...
1. On the Volume Encryption Keys page, for the selected volume, click Edit ![](Volumes-127.gif) . The Edit Encryption Keys dialog box appears.
...
1. On the Volume Name page, select a volume, then click Edit ![](Volumes-130.gif) . The Volume Name Settings dialog box appears.
...
1. For the selected volume, click Edit ![](Volumes-135.gif) . The Volume Protocol Settings dialog box appears.
...
1. For the selected volume with NTFS Compatible Mode for its Permissions Policy, click Edit ![](Volumes-139.gif) . The Volume Protocol Settings dialog box appears.
...
* _Limit:_ The limit for the quota.
* _Usage:_ The current storage usage for the folder, and the percentage of the quota.
* For the folder quota that you want to delete, click Delete ![](Volumes-147.gif) . The Delete Quota Settings dialog box appears. Click Delete Quota. The quota is deleted.
...
* _Email:_ The email address to use for alerts for this quota rule.
* _Limit:_ The limit for the quota rule.
* For the quota rule that you want to delete, click Delete ![](Volumes-152.gif) . The Delete Quota Rule dialog box appears. Click Delete Rule. The quota rule is deleted.
